...
const EspiritoSanto = () => {
  const benefits = [
    {
      icon: Truck,
      title: 'Entrega Ágil no Espírito Santo',
      description: 'Prazos reduzidos e logística otimizada para todo o estado do Espírito Santo.'
    },
    {
      icon: Shield,
    ...
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Caixas de Papelão no <span className="text-secondary">Espírito Santo</span>
            </h1>
             <p className="text-xl text-gray-200 leading-relaxed">
               A Splendida é uma fábrica de caixas de papelão e oferece soluções completas em embalagens de papelão para Espírito Santo, 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-foreground">
              Presença Estratégica no Espírito Santo
            </h2>
            <div className="space-y-4 text-gray-text text-lg">
              <p>
                A Splendida é uma empresa com grande experiência no desenvolvimento de embalagens de papelão no Espírito Santo. 
                Contamos com elevados padrões de qualidade, eficiência e desempenho para oferecer as melhores embalagens 
                de papelão no estado do Espírito Santo.
              </p>
              <p>
                Trabalhamos com o objetivo de atender todas as necessidades dos clientes que solicitam caixas de papelão 
                no Espírito Santo, fornecendo soluções personalizadas e eficientes para diversos segmentos industriais.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-text max-w-2xl mx-auto">
              Fornecemos embalagens de papelão no Espírito Santo para empresas dos mais diversos portes e segmentos do mercado.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="space-y-4 text-gray-text text-lg">
              <p>
                ...
                no Espírito Santo, com um excelente prazo. Contamos com uma ótima estrutura para garantir prazos curtos 
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-text max-w-2xl mx-auto">
              Oferecemos uma ampla variedade de embalagens de papelão no Espírito Santo.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center mt-12">
            <div className="space-y-4 text-gray-text text-lg">
              <p>
                A Splendida comercializa embalagens de papelão no Espírito Santo com qualquer especificação técnica exigida 
                pelos clientes. Oferecemos modelos de embalagens de papelão personalizados, com impressões em diferentes cores.
              </p>
              <p>
                Fabricamos caixas de papelão no Espírito Santo, com a utilização de papéis e tintas que apresentam menor 
      ...
      <section className="py-16 bg-light-blue">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-foreground">
              Setores Atendidos no Espírito Santo
            </h2>
            <p className="text-xl text-gray-text max-w-2xl mx-auto">
              Atendemos diversos segmentos industriais em todo o estado do Espírito Santo.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-4 text-gray-text text-lg">
              <p>
                ...
                de papelão no Espírito Santo. Nossa equipe regional está preparada para oferecer o melhor atendimento e 
      ...
      <section className="py-16 bg-gradient-hero text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Solicite um Orçamento para o Espírito Santo!
          </h2>
          <p className="text-xl mb-8 text-gray-200 max-w-2xl mx-auto">
            Entre em contato com a Splendida para solicitar um orçamento de embalagens de papelão no Espírito Santo, sem compromisso.
          </p>
