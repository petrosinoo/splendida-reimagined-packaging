...
const Bahia = () => {
  const benefits = [
    {
      icon: Truck,
      title: 'Entrega Ágil na Bahia',
      description: 'Prazos reduzidos e logística otimizada para todo o estado da Bahia.'
    },
    {
      icon: Shield,
    ...
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Embalagens de Papelão na <span className="text-secondary">Bahia</span>: 
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-text max-w-2xl mx-auto">
              Fornecemos embalagens de papelão na Bahia para empresas dos mais diversos portes e segmentos do mercado.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="space-y-4 text-gray-text text-lg">
              <p>
                ...
                na Bahia, com um excelente prazo. Contamos com uma ótima estrutura para garantir prazos curtos 
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-text max-w-2xl mx-auto">
              Oferecemos uma ampla variedade de embalagens de papelão na Bahia.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center mt-12">
            <div className="space-y-4 text-gray-text text-lg">
              <p>
                A Splendida comercializa embalagens de papelão na Bahia com qualquer especificação técnica exigida 
                pelos clientes. Oferecemos modelos de embalagens de papelão personalizados, com impressões em diferentes cores.
              </p>
              <p>
                Fabricamos caixas de papelão na Bahia, com a utilização de papéis e tintas que apresentam menor 
      ...
      <section className="py-16 bg-light-blue">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-foreground">
              Setores Atendidos na Bahia
            </h2>
            <p className="text-xl text-gray-text max-w-2xl mx-auto">
              Atendemos diversos segmentos industriais em todo o estado da Bahia.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-4 text-gray-text text-lg">
              <p>
                ...
                de papelão na Bahia. Nossa equipe regional está preparada para oferecer o melhor atendimento e 
      ...
      <section className="py-16 bg-gradient-hero text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Solicite um Orçamento para a Bahia!
          </h2>
          <p className="text-xl mb-8 text-gray-200 max-w-2xl mx-auto">
            Entre em contato com a Splendida para solicitar um orçamento de embalagens de papelão na Bahia, sem compromisso.
          </p>
